...
Provides full information about a zone in Selectel DNS Hosting (actual). If you want manage a zone use [resource selectel_domains_zone_v2](https://registry.terraform.io/providers/selectel/selectel/latest/docs/resources/selectel_domains_zone_v2). For more information about zones, see the [official Selectel documentation](https://docs.selectel.ru/networks-services/dns/zones/).
